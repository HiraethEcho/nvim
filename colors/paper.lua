...
-- ── blink.cmp ──────────────────────────────────────────────
hi("BlinkCmpMenu",            { fg = colors.fg, bg = colors.bg_float })
hi("BlinkCmpMenuBorder",      { fg = colors.border })
hi("BlinkCmpMenuSelection",   { fg = colors.fg, bg = colors.bg_dark, bold = true })
hi("BlinkCmpLabel",           { fg = colors.fg })
hi("BlinkCmpLabelMatch",      { fg = colors.keyword, bold = true })
hi("BlinkCmpLabelDescription",{ fg = colors.fg_subtle })
hi("BlinkCmpLabelDetail",     { fg = colors.fg_subtle })
hi("BlinkCmpKind",            { fg = colors.fg_subtle })
...
hi("BlinkCmpGhostText",       { fg = colors.fg_faint })
hi("BlinkCmpKindDefault",     { fg = colors.fg_subtle })
