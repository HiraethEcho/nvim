...
---
```snippets
snippet liu_template "Jihao Liu template" b
  ...
  \newcommand\wang[1]{\todo[color=yellow!40]{#1}} %Wangn
  \newcommand\haninline[1]{\todo[inline,color=yellow!40]{#1}} %Wang inline
  \newcommand\chen[1]{\todo[color=pink!40]{#1}} %Chen
  \newcommand\cheninline[1]{\todo[inline,color=pink!40]{#1}} %Chen inline
  ...
  \title{Sarkisov program for algebraically integrable foliations on potentially klt varieties}
  \author{Yifei Chen, Jihao Liu, and Yanze Wang}

  \subjclass[2020]{14E30, 37F75}
  \keywords{Minimal model program. Algebraically integrable foliation. Sarkisov program.}
  \date{\today}
